    ...
    const animalItem = this.state.baseAnimals.map((animalItem, i) => {
      ...
      return (
        <div className="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
          <a className="card-link" href="#animal" onMouseDown={(e)=>this.props.goToAnimal(this.props.animalItem, e)}>
              ...
              <div className="card-body">
                ...
                <div className="container-card-list-group">
                  <ul className="card-list-group">
                    ...
                    <li className="card-list-group-item">{animalItem.zone}-{animalItem.id}</li>
                  </ul>
                </div>
                <div className="d-flex justify-content-between align-items-center">
                  <form>
