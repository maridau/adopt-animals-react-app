          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav mr-auto">
              <li className="nav-item">
                <a className="nav-link" href="#home" onClick={this.goToListAnimals}><img src="assets/icons/ico-home.png" width="50" height="50"
                    className="d-inline-block align-center" alt="Inicio"></img>ANIMALES PARA ADOPCIÓN </a>
              </li>
              <li className="nav-item">
                <a className="nav-link" href="#register" onClick={this.goToRegister}><img src="assets/icons/ico-new.png" width="50" height="50"
              ...
              <li className="nav-item">
                <a className="nav-link" href="#blog" onClick={this.goToBlog}><img src="assets/icons/ico-blog.png" width="50" height="50"
